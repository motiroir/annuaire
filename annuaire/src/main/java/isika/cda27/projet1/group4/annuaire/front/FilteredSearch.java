...
public class FilteredSearch extends HBox {
    ...
    public FilteredSearch(App app) {
        ...
        Image filterIcon = new Image(getClass().getResourceAsStream("/icons/__filter-icon.png"));
        ...
        this.getChildren().addAll(nameField, firstNameField, promotionField, departmentField, emailField, toggleButton, filterButton);
        this.setSpacing(10);
    ...
    private void updateSearchResults() {
        ...
        //List<Stagiaire> results = app.myDAO.searchByCriteria(nameQuery, firstNameQuery, promotionQuery, departmentQuery, emailQuery);
